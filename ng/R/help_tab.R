      ...
      output$help <- renderUI({
        ...
        tagList(
          ...
          p("An R Shiny app for UCL Statistical Sciences department room booking.
            ...
            access to information about which rooms are not available at any given time.
            ...
            That is, a room owner must change their room status to In first before a someone
            can book it."),
